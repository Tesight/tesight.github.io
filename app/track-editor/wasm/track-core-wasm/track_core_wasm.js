/* @ts-self-types="./track_core_wasm.d.ts" */

/**
 * @param {any} request
 * @returns {any}
 */
export function buildTemplateFile(request) {
    const ret = wasm.buildTemplateFile(request);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function buildTrack(request) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.buildTrack(request);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {any}
 */
export function gcjToWgsCoord(request) {
    const ret = wasm.gcjToWgsCoord(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function instantiateTemplateTrack(request) {
    const ret = wasm.instantiateTemplateTrack(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function loadTemplateJson(request) {
    const ret = wasm.loadTemplateJson(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function previewTrack(request) {
    const ret = wasm.previewTrack(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function rebaseStart(request) {
    const ret = wasm.rebaseStart(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function resolveWaypoint(request) {
    const ret = wasm.resolveWaypoint(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function wgsToGcjCoord(request) {
    const ret = wasm.wgsToGcjCoord(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('track_core_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
